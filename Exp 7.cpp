...
int main()
{
    ...
    q->Front = q->rear = NULL;
    cout<<"1.enqueue using array 2.dequeue using array 3.display using array 4.enqueue using linked list 5.dequeue using linked list 6.display using linked list"<<endl;
    while(ch!=7)
    {
        cin>>ch;
        switch(ch)
